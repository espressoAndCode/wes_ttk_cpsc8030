/// \ingroup vtk
/// \class ttkBoundaryBased
/// \author Your Name Here <Your Email Address Here>
/// \date The Date Here.
///
/// \brief TTK VTK-filter that wraps the boundaryBased processing package.
///
/// VTK wrapping code for the @BoundaryBased package.
/// 
...
#ifndef TTK_PLUGIN
class VTKFILTERSCORE_EXPORT ttkBoundaryBased
#else
class ttkBoundaryBased
#endif
  ...
  public:
    ...
    static ttkBoundaryBased* New();
    vtkTypeMacro(ttkBoundaryBased, vtkDataSetAlgorithm)
  ...
  private:
    ...
    ttk::BoundaryBased            boundaryBased_;
